#!/usr/bin/env python3
"""
Advanced Audio Script Generator for PerfectBrew
...
class AdvancedAudioScriptGenerator:
    def __init__(self):
        ...
        # Advanced narration templates with specific technique guidance
    ...
    def generate_advanced_audio(self, recipe: Dict[str, Any], output_dir: str) -> None:
        """Generate advanced audio for a single recipe."""
        recipe_title = recipe.get("title", "Unknown Recipe")
        print(f"\n🎵 Generating advanced audio for: {recipe_title}")
        ...
        print(f"🎉 Advanced audio generation complete for {recipe_title}!")
...
def main():
    """Main function to generate advanced audio for recipes."""
    print("🚀 Advanced Audio Script Generator for PerfectBrew")
    print("=" * 60)
    
    # Initialize generator
    generator = AdvancedAudioScriptGenerator()
    ...
    for recipe in recipes:
        ...
        output_dir = f"PerfectBrew/Resources/Audio/V60/{folder_name}_Advanced"
        
        try:
            generator.generate_advanced_audio(recipe, output_dir)
        except Exception as e:
            print(f"❌ Error processing {recipe_title}: {e}")
            continue
    
    print("\n🎉 Advanced audio generation complete for all V60 recipes!")
