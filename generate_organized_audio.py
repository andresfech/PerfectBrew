...
Mantiene la estructura y orden de las recetas originales
"""
...
def load_recipes_by_method():
    ...
    recipe_files = [
        ...
        ("PerfectBrew/Resources/recipes_frenchpress.json", "French Press")
    ]
...
def generate_audio_for_recipe(recipe, model, output_dir, method, language="es"):
...
def main():
    ...
    for method, recipes in recipes_by_method.items():
        ...
        for i, recipe in enumerate(recipes, 1):
            ...
            try:
                files = generate_audio_for_recipe(recipe, model, ios_audio_dir, method, language="es")
