#!/usr/bin/env python3
"""
Test Audio Script Generator for Kaldi's Coffee - Single Serve
...
def main():
    ...
    print("🚀 Enhanced Audio Generator for Kaldi's Coffee - Single Serve")
    print("=" * 70)
    
    # Initialize generator
    generator = KaldiAudioGenerator()
    ...
    # Generate audio
    output_dir = "PerfectBrew/Resources/Audio/V60/Kaldi_Coffee_Single_Serve_Enhanced"
    generator.generate_kaldi_audio(kaldi_recipe, output_dir)
    
    print("\n🎉 Enhanced audio generation complete!")
    print("📁 Audio files saved in: PerfectBrew/Resources/Audio/V60/Kaldi_Coffee_Single_Serve_Enhanced/")
