...
class LocalizationManager: ObservableObject {
    ...
    private var translations: [String: [String: String]] = [
        "en": [
            ...
            "within_expected": "Within expected",
            "above_expected": "Above expected",
            "taste_low": "Low",
            "taste_medium": "Medium",
            "taste_high": "High",
            "expected_range": "Expected for this coffee",
            "explanation_below_expected": "Lower than what this coffee typically delivers. Try increasing extraction next time.",
            "explanation_within_expected": "Matches what this coffee typically delivers. You're in the right range.",
            "explanation_above_expected": "Higher than what this coffee typically delivers. Try reducing extraction next time.",
            "explanation_taste_low": "On the lower end. Consider boosting extraction if you want more.",
            "explanation_taste_medium": "Right in the middle. A balanced result.",
            "explanation_taste_high": "On the higher end. Consider reducing extraction if it's too much.",
            "body_mouthfeel": "Body/Mouthfeel",
            "clear_entry": "Clear Entry",
            "how_to_self_assess": "How to Self-Assess",
            "taste_self_assess_guide": "Compare each dimension (acidity, sweetness, body) to what you wanted. Use the 1–5 scale: left is lower, right is higher. If you've selected a coffee, the hatched zone shows what this coffee typically delivers. Drag the circle to rate; tap Save when done.",
            "dismiss": "Dismiss",
            "save_taste_subtitle": "Save taste ratings",
            "rate_taste": "Rate taste",
        ...
        "es": [
            ...
            "perfect": "Perfecto",
            "too_much": "Demasiado",
            "below_expected": "Por debajo de lo esperado",
            "within_expected": "Dentro de lo esperado",
            "above_expected": "Por encima de lo esperado",
            "taste_low": "Bajo",
            "taste_medium": "Medio",
            "taste_high": "Alto",
            "expected_range": "Esperado para este café",
            "explanation_below_expected": "Por debajo de lo que suele dar este café. Prueba a aumentar la extracción.",
            "explanation_within_expected": "Coincide con lo que suele dar este café. Estás en el rango adecuado.",
            "explanation_above_expected": "Por encima de lo que suele dar este café. Prueba a reducir la extracción.",
            "explanation_taste_low": "En el extremo bajo. Considera subir la extracción si quieres más.",
            "explanation_taste_medium": "En el punto medio. Un resultado equilibrado.",
            "explanation_taste_high": "En el extremo alto. Considera bajar la extracción si es demasiado.",
            "body_mouthfeel": "Cuerpo/Sensación en Boca",
            "clear_entry": "Borrar",
            "how_to_self_assess": "Cómo autoevaluarse",
            "taste_self_assess_guide": "Compara cada dimensión (acidez, dulzura, cuerpo) con lo que querías. Usa la escala 1–5: izquierda es menos, derecha es más. Si elegiste un café, la zona rayada muestra lo que suele dar. Arrastra el círculo para puntuar; pulsa Guardar al terminar.",
            "dismiss": "Cerrar",
            "save_taste_subtitle": "Guardar valoración de sabor",
            "rate_taste": "Valorar sabor",
